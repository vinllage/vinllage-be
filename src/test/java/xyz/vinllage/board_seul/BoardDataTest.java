...
class BoardDataInfoServiceTest {
    ...
    private BoardDataInfoService_seul boardDataInfoServiceSeul;
...
class BoardDataUpdateServiceTest {
    ...
    private ModelMapper mapper;
    private BoardDataUpdateService_seul updateService;
    private PasswordEncoder encoder;
    private MemberUtil memberUtil;
    private MockHttpServletRequest request;

    private BoardInfoService_seul boardInfoServiceSeul;
    private BoardDataDeleteService_seul boardDeleteServiceSeul;
    ...
    void updateExistingBoardData() {
        ...
        try {
            boardDeleteServiceSeul.delete(saved.getSeq());
