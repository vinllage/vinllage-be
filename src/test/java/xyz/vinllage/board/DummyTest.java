...
class BoardInfoServiceTest {
    ...
    void setUp() {
        ...
        boardInfoService = new BoardInfoService(mockRequest, boardRepository, new ModelMapper());
    ...
    void getAllBoards() {
        ...
        // When
        ListData<Board> result = boardInfoService.getList(search);
    ...
    void testForm() {
        ...
        // When
        RequestBoard board = boardInfoService.getForm("notice");
