//package xyz.vinllage.global.email.service;
//
...
//            tplData.put("subject", message.subject()); // 제목
//            tplData.put("message", message.message());// 내용
//
...
//            mimeMessageHelper.setTo(message.to());// 매일 수신자
