...
public class MemberController {
    ...
    @PostMapping("/token")
    public String token(@Valid @RequestBody(required = false) RequestLoginToken form, @Valid @RequestBody(required = false) RequestSocialToken socialToken, Errors errors) {
