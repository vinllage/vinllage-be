...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = -531763084L;
    ...
    public final xyz.vinllage.board.board.entities.QBoard board;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.board = inits.isInitialized("board") ? new xyz.vinllage.board.board.entities.QBoard(forProperty("board")) : null;
